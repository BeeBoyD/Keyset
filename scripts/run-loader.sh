...
case "$loader" in
  fabric)
    ...
    notes=(
      ...
      "- The active 1.3.x release line ships 1.20.1+; older Fabric leaves are maintenance-only."
    )
    examples=(
  ...
  forge)
    ...
    notes=(
      ...
      "- The active 1.3.x release line ships 1.20.1+ and still caps Forge at 1.21.1."
    )
    examples=(
      "./run-forge.sh 1.20.6"
  ...
  quilt)
    ...
    notes=(
      ...
      "- The active 1.3.x release line ships 1.20.1+; older Quilt/Fabric leaves are maintenance-only."
    )
    examples=(
      "./run-quilt.sh 1.21.3"
